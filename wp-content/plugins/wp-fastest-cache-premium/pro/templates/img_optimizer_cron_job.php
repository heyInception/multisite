				...
				<div id="wpfc-wizard-csp" class="wpfc-cdn-pages-container">
					<div wpfc-cdn-page="1" class="wiz-cont">
						...
						<div class="wiz-input-cont">
							...
							?>
							<input onClick="this.select();" value="wget --no-check-certificate -b &quot;<?php echo get_site_url('', '?action=wpfastestcache&type=optimizeimage&security='.$wpfc_img_opt_nonce); ?>&quot; >/dev/null 2>&1" readonly type="text" name="url" class="api-key" style="width: 100%;">
					    </div>
